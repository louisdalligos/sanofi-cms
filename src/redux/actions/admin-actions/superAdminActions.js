...
export function createAdmin(values) {
    return async dispatch => {
        ...
        try {
            const response = await SuperAdminServices.createAdminRequest(
                values
            ); // POST request
...
export function updateAdmin(id, values) {
    return async dispatch => {
        ...
        try {
            const response = await SuperAdminServices.updateAdminRequest(
                id,
                values
            ); // POST request
            dispatch({
...
export function undoDeleteAdmin(id) {
    return async dispatch => {
        ...
        try {
            const response = await SuperAdminServices.undoDeleteAdminRequest(
                id
            ); // PUT request
            dispatch({
...
export function fetchCurrentAdmin(id) {
    return async dispatch => {
        ...
        try {
            const response = await SuperAdminServices.fetchCurrentAdminRequest(
                id
            ); // GET request
...
export function fetchCurrentUser(id) {
    return async dispatch => {
        ...
        try {
            const response = await SuperAdminServices.fetchCurrentUserRequest(
                id
            ); // GET request
