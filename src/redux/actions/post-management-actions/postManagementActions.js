...
export function addSubCategory(values) {
    return async dispatch => {
        ...
        try {
            const res = await PostManagementServices.addSubCategoryRequest(
                values
            ); // POST request
            console.log(res);
            await dispatch({
...
export function createArticle(values) {
    return async dispatch => {
        ...
        try {
            const res = await PostManagementServices.createArticleRequest(
                values
            ); // POST request
            console.log(res);
            await dispatch({
...
export function updateArticle(id, values) {
    return async dispatch => {
        ...
        try {
            const res = await PostManagementServices.updateArticleRequest(
                id,
                values
            ); // PUT request
