...
class SubCategoriesManagementComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      category: "",
            ...
            {this.state.editCursor === category.id ? (
              <div>
                <Input
                  ...
                  onKeyDown={evt => {
                    if (evt.keyCode === 13) this.triggerEditSaveCategory();
                  }}
                />
        ...
        <div className="dnd-header dnd-table">
          ...
          >
            <Input
              ...
              onKeyDown={evt => {
                if (evt.keyCode === 13) this.triggerSaveNewCategory();
              }}
            />
          ...
          <div className="grid-right">
            <Button type="primary" onClick={this.triggerSaveNewCategory}>
              Add Subcategory
            </Button>
          </div>
        </div>
...
export default SubCategoriesManagementComponent;
