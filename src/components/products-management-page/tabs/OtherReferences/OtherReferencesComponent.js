    ...
    constructor(props) {
        ...
        this.columns = [
            ...
            },
            {
                ...
                render: (
                    text,
                    { type, filename, path, video_link, link },
                    index
                ) => {
                    let caption = "default";
                    switch (type) {
                ...
                render: (text, row, index) => {
                    return (
                        <Button
                            type="danger"
                            onClick={() => {
                                this.props.deleteOtherReferences(
                                    row.id,
                                    this.props.id
                                );
        ...
        this.setState(
            ...
            () => {
                if (
                    ...
                    this.props.saveFilePostOtherReferences(
                        this.props.id,
                        formData
                    );
                }
    ...
    return (
        ...
        >
            {({ field, meta }) => {
                ...
                const classnames =
                    "ant-form-item-control " + (dirty && "has-error");
                return (
