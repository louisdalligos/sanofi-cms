...
const { Option } = Select;
const pageTitle = "Create a CMS admin";
...
const CreateAdminForm = ({
  ...
  const getAdminRequesterData = data => {
    ...
    <Fragment>
      <div className="box-layout-custom">
        ...
        <Row>
          ...
          <AdminRequestTable getAdminRequesterData={getAdminRequesterData} />
        </Row>
        ...
        <Form onSubmit={handleSubmit} className="single-form">
          ...
          <Form.Item label="Email">
            ...
            })(<Input placeholder="Enter an email" disabled={emailDisabled} />)}
          </Form.Item>
