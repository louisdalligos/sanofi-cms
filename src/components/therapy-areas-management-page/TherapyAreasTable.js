...
const TherapyAreasTable = ({
            ...
            render: (text, record) => (
                <div className="table-title-featured-wrap">
                    ...
                    <div>
                        ...
                        >
                            <Link
                                to={`/therapy-areas/${record.id}`}
                                title={text}
                            >
                                <Typography.Text
                                    ellipsis={true}
                                    style={COLUMN_ITEM_LINK}
                                >
                                    {text}
                                </Typography.Text>
                            </Link>
    ...
    const fetch = (params = {}) => {
        ...
        axios({
            ...
            .then(response => {
                setTotal(
                    response.data.info ? response.data.info.total_count : null
        ...
        axios({
            ...
            .then(response => {
                ...
                if (response.data.success === "No results found") {
                    ...
                    setTotal(
                        response.data.info
                            ? response.data.info.total_count
                            : null
                    ); // get total count from server and set to state
                }
